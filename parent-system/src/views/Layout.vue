<template>
  <a-layout id="components-layout-demo-side" style="min-height: 100vh">
    <div class="header">
      <div class="toplogo">
        <img src="../assets/logo.png" @click="toggleTheme" />大气环境溯源分析
      </div>
      <a-menu
        theme="dark"
        mode="horizontal"
      ...
      <span class="user" v-if="getToken" @click="out"
        >admin<a-icon type="down"
      /></span>
      <span class="user" v-else @click="login">登录</span>
    </div>
    <a-layout>
        ...
        <a-layout-content style="margin: 0 16px">
          ...
          >
            ...
            <div
              ...
              v-show="$route.path.startsWith(o.activeRule)"
              :key="o.name"
            >
              <KeepAlive>
